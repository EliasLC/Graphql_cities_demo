...
export const resolvers = {
    Query: {
        cities: async (_root: any, { name } : any) => {
            const result = await getCities(name)

            return result
        },
        municipalities: async (_root: any, { name } : any) => {
    ...
    Mutation: {
        createCity: async (_root: any, { data }: any) => {
            console.log(data)
        ...
        createMunicipality: async (_root: any, { data }: any) => {
            console.log(data)
        ...
        createRanch: async (_root: any, { data }: any) => {
            console.log(data)
